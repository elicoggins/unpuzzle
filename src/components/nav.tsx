...
export function Nav() {
  ...
  return (
    <nav className="border-b border-border px-6 py-2 flex items-center justify-between">
      <Link
        href="/"
      ...
      >
        <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-6 h-6 fill-accent">
        ...
        <span>un<span className="text-accent">puzzle</span></span>
      </Link>
